        ...
        <div style={{ height: 'calc(100% - 12px)' }}>
          {
            sampleOptions.channelType === ChannelType.GROUP && (
              <App
                ...
                allowProfileEdit={typeof sampleOptions.editUserProfile === 'boolean' ? !sampleOptions.editUserProfile : undefined}
                showSearchIcon={sampleOptions.messageSearch}
                disableUserProfile={typeof sampleOptions.showUserProfile === 'boolean' ? !sampleOptions.showUserProfile : undefined}
