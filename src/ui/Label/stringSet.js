const getStringSet = (lang = 'en') => {
  const stringSet = {
    en: {
      ...
      OPEN_CHANNEL_SETTINGS__MUTED_MEMBERS__TITLE: 'Muted users',
      OPEN_CHANNEL_SETTINGS__MUTED_MEMBERS__TITLE_ALL: 'All muted users',
      OPEN_CHANNEL_SETTINGS__MUTED_MEMBERS__NO_ONE: 'No muted users yet',
