  ...
  var N = (function () {
    ...
    M = (function () {
      function e() {
        ...
        c(this, e), R.set(this, "object" === u(n) && n ? n : {});
      }
      return (
        h(
          e,
          ...
          [
            {
              key: "create",
              value: function (n, t) {
                return (T[n] = new e(t)), T[n];
              },
            },
            {
              key: "get",
              value: function (e) {
                return e || (e = gt.getInstance()._iid), T[e];
              },
            },
          ]
        ),
            ...
            },
            {
              ...
              value: function (n, t) {
                var i = this,
                  ...
                  c = n.includeReaction,
                  d = n.includeReactions,
                  h = n.includeReplies,
                  p = n.includeParentMessageText,
                  f = n.includeThreadInfo,
                  y = n.replyType,
                  g = n.includeParentMessageInfo,
                  _ = n.includePollDetails;
                this.sb.ConnectionManager.ready(function (n, m) {
                  if (n) t(n, null);
                    ...
                    o && E.add("token", o),
                      ...
                      s && E.add("change_ts", s),
                      "boolean" == typeof u &&
                        E.add("with_sorted_meta_array", u),
                      "boolean" == typeof d
                        ? E.add("include_reactions", d)
                        : E.add(
                            "include_reactions",
                            "boolean" == typeof c && c
                          ),
                      "boolean" == typeof f && E.add("include_thread_info", f),
                      "string" == typeof y
                        ? E.add("include_reply_type", y)
                        : E.add(
                            "include_reply_type",
                            "boolean" == typeof h && h
                              ? i.cls.BaseMessage.ReplyType.ALL
                              : i.cls.BaseMessage.ReplyType.NONE
                          ),
                      "boolean" == typeof g
                        ? E.add("include_parent_message_info", g)
                        : E.add(
                            "include_parent_message_info",
                            "boolean" == typeof p && p
                          ),
                      "boolean" == typeof _ && E.add("include_poll_details", _),
                      i.get(v, E, t);
                  }
                });
              },
            ...
            },
            {
              ...
              value: function (n, t) {
                var i = this,
                  ...
                  m = n.includeReaction,
                  v = n.includeReactions,
                  E = n.includeReplies,
                  C = n.includeParentMessageText,
                  b = n.includeThreadInfo,
                  U = n.replyType,
                  A = n.includeParentMessageInfo,
                  I = n.showSubchannelMessagesOnly,
                  S = n.includePollDetails,
                  k = n.rootMessageId,
                  O = n.parentMessageId;
                this.sb.ConnectionManager.ready(function (n, l) {
                  if (n) t(n, null);
                    ...
                    "timestamp" === s
                      ? N.add("message_ts", a)
                      : "messageId" === s && N.add("message_id", String(a)),
                      p && N.add("message_type", String(p)),
                      Array.isArray(y) &&
                        (0 === y.length &&
                          ("string" == typeof f ? y.push(f) : y.push("*")),
                        N.add("custom_types", y)),
                      Array.isArray(g) &&
                        g.length > 0 &&
                        N.add("sender_ids", g),
                      "boolean" == typeof _ &&
                        N.add("with_sorted_meta_array", _),
                      "boolean" == typeof v
                        ? N.add("include_reactions", v)
                        : N.add(
                            "include_reactions",
                            "boolean" == typeof m && m
                          ),
                      "boolean" == typeof b && N.add("include_thread_info", b),
                      "string" == typeof U
                        ? N.add("include_reply_type", U)
                        : N.add(
                            "include_reply_type",
                            "boolean" == typeof E && E
                              ? i.cls.BaseMessage.ReplyType.ALL
                      ...
                      "boolean" == typeof A
                        ? N.add("include_parent_message_info", A)
                        : N.add(
                            "include_parent_message_info",
                            "boolean" == typeof C && C
                          ),
                      "boolean" == typeof I &&
                        r.isOpenChannel() &&
                        N.add("show_subchannel_messages_only", I),
                      "boolean" == typeof S && N.add("include_poll_details", S),
                      k && N.add("root_message_id", k),
                      O && N.add("parent_message_id", O),
                      i.get(c, N, t);
                  }
                });
              },
            ...
            },
            {
              ...
              value: function (n, t) {
                var i = this,
                  ...
                  l = n.includeParentMessageText,
                  u = n.includeThreadInfo,
                  c = n.includeParentMessageInfo,
                  d = n.includePollDetails;
                this.sb.ConnectionManager.ready(function (n, h) {
                  if (n) t(n, null);
                  else {
                    var p = r.isOpenChannel()
                      ...
                      f = new Z({ is_sdk: String(!0) });
                    "boolean" == typeof s && f.add("with_sorted_meta_array", s),
                      "boolean" == typeof o && f.add("include_reactions", o),
                      "boolean" == typeof u && f.add("include_thread_info", u),
                      "boolean" == typeof c
                        ? f.add("include_parent_message_info", c)
                        : f.add(
                            "include_parent_message_info",
                            "boolean" == typeof l && l
                          ),
                      "boolean" == typeof d && f.add("include_poll_details", d),
                      i.get(p, f, t);
                  }
                });
              },
              ...
              value: function (n, t) {
                ...
                this.sb.ConnectionManager.ready(function (n, h) {
                  if (n) t(n, null);
                    ...
                    var p = e.Path.POLLS,
                      f = new Z({ title: r, options: a });
                    "object" === u(s) && f.add("data", s),
                      "boolean" == typeof o && f.add("is_anonymous", o),
                      "boolean" == typeof l &&
                        f.add("allow_user_suggestion", l),
            ...
            },
            {
              ...
              value: function (n, t) {
                var i = this,
                  ...
                  o = n.data,
                  l = n.isAnonymous,
                  c = n.allowUserSuggestion,
                  d = n.allowMultipleVotes,
                  h = n.closeAt;
                this.sb.ConnectionManager.ready(function (n, p) {
                  if (n) t(n, null);
                  else {
                    var f = e.Path.POLLS_POLLID.replace("%s", r),
                      y = new Z();
                    "string" == typeof a && y.add("title", a),
                      Array.isArray(s) && y.add("options", s),
                      "object" === u(o) && y.add("data", o),
                      "boolean" == typeof l && y.add("is_anonymous", l),
                      "boolean" == typeof c &&
                        y.add("allow_user_suggestion", c),
                      "boolean" == typeof d && y.add("allow_multiple_votes", d),
                      "number" == typeof h && y.add("close_at", h),
                      i.put(f, y, t);
                  }
                });
              },
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var f = e.hasOwnProperty("metaarray") ? e.metaarray : {},
                  y = e.hasOwnProperty("metaarray_key_order")
                    ? e.metaarray_key_order
                    : Object.keys(f).sort(function (e, n) {
                        return e.localeCompare(n);
                      });
                this.metaArrays = [];
                for (var g = 0; g < y.length; g++) {
                  var _ = y[g];
                  this.metaArrays.push(new c(_, f[_] || []));
                }
                if (e.hasOwnProperty("sorted_metaarray")) {
                  var m = e.sorted_metaarray;
                  Array.isArray(m) &&
                    (this.metaArrays = m.map(function (e) {
                ...
                if (
                  ...
                  for (var v = 0; v < e.reactions.length; v++) {
                    var E = u.createFromJson(e.reactions[v]);
                    E && this.reactions.push(E);
                  }
                ...
                if (
                  ...
                  (this.threadInfo = new d(e.thread_info)),
                  (this.isReplyToChannel =
                    !!e.hasOwnProperty("is_reply_to_channel") &&
                    e.is_reply_to_channel),
                  e.hasOwnProperty("parent_message_info"))
                ) {
                  var C = l({}, e.parent_message_info);
                  e.parent_message_info.hasOwnProperty("file") &&
                    (C.require_auth = !!e.parent_message_info.file
                      .require_auth);
                  var b = {
                  ...
                  switch (
                    ((this.parentMessage = a.buildMessage(C, b)),
                      ...
                      if (u) r(u, null);
                        ...
                        a.isGroupChannel()
                          ? o.getChannel(
                              ...
                              function (s, o) {
                                if (
                                  gt.getInstance(a._iid).getErrorFirstCallback()
                                ) {
                                  var u = [s, o];
                                  (o = u[0]), (s = u[1]);
                                }
                        ...
                        switch (e.channelType) {
                          case r.CHANNEL_TYPE_GROUP:
                            a.getChannel(
                              ...
                              function (i, a) {
                                if (
                                  gt.getInstance(t._iid).getErrorFirstCallback()
                                ) {
                                  var s = [i, a];
                                  (a = s[0]), (i = s[1]);
                                }
          ...
          [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var b = gt.getInstance(this._iid),
                  U = {};
                Array.isArray(h) &&
            ...
            },
            {
              ...
              value: function (e) {
                try {
                  var n = gt.getInstance(this._iid),
                    t = D.get(this._iid),
                    i = t.Command,
                    r = t.FileMessage,
                    a = r.objectify(
            ...
            },
            {
              ...
              value: function () {
                ...
                e.error ||
                  ...
                  (r = i.reqId));
                var a = gt.getInstance(this._iid);
                (a && a.currentUser) ||
                  (e.error = new P(
                    "Connection should be made first.",
                    P.CONNECTION_REQUIRED
            ...
            },
            {
              ...
              value: function (n, t, i) {
                ...
                var y = gt.getInstance(this._iid),
                  g = t,
                  _ = g.url,
                  m = g.name,
                  v = g.type,
        ...
        h(e, [
          {
            ...
            value: function (e) {
              var n = this,
                ...
                p = t.FileMessage,
                f = t.AdminMessage,
                y = t.BaseMessageParams,
                g = t.ReactionEvent,
                _ = t.ReadStatus,
                m = t.ThreadInfoUpdateEvent,
                v = t.PollUpdateEvent,
                E = t.PollVoteEvent,
                C = t.RestrictionInfo,
                b = M.get(this.sb._iid),
                U = b.container,
                A = U.pinger,
                I = U.auth,
                S = U.subscribedUnreadMessageCount,
                k = U.sessionManager,
                T = U.ackStateMap,
                R = new i(e),
                L = R.getJsonElement();
              if (
                L.hasOwnProperty("unread_cnt") &&
                "object" === u(L.unread_cnt)
              ) {
                var w = !1,
                  D = L.unread_cnt.ts;
                "number" == typeof D &&
                  D > S.ts &&
                  (S.all !== L.unread_cnt.all && (w = !0),
                  (S.all = L.unread_cnt.all >= 0 ? L.unread_cnt.all : 0),
                  L.unread_cnt.custom_types &&
                    Object.keys(L.unread_cnt.custom_types).forEach(function (
                      e
                    ) {
                      S.custom_types[e] !== L.unread_cnt.custom_types[e] &&
                        (w = !0),
                        (S.custom_types[e] = L.unread_cnt.custom_types[e]);
                    }),
                  (w = w && S.ts > 0),
                  ...
                  w &&
                    Object.keys(this.sb.userEventHandlers).forEach(function (
                      ...
                      n.sb.userEventHandlers[
                        e
                      ].onTotalUnreadMessageCountUpdated(S.all, S.custom_types);
                    });
              }
              var H = R.requestId;
              if (H) {
                ...
                if (F) {
                  ...
                  G &&
                    ("EROR" === R.command
                      ? G(new P(L.message, L.code), null)
                      : G(null, R)),
                    T.hasOwnProperty(H) && delete T[H];
                }
              } else
                switch (
                  (A && "LOGI" !== R.command && A.refreshTimer(), R.command)
                ) {
                  case "LOGI":
                    this.sb.loginTimer &&
                      (clearTimeout(this.sb.loginTimer),
                      ...
                      L.hasOwnProperty("error")
                        ? ((this.sb.isSessionOpened = !1),
                          this.sb.loginHandler(new P(L.message, L.code), null))
                        : ((this.sb.isSessionOpened = !0),
                          L.hasOwnProperty("key") && (I.sessionKey = L.key),
                          L.hasOwnProperty("ekey") && (I.eKey = L.ekey),
                          L.hasOwnProperty("user_id") &&
                            (this.sb.currentUser = new r(L)),
                          "number" == typeof L.ping_interval &&
                            L.ping_interval > 0 &&
                            b.set("pingInterval", 1e3 * L.ping_interval),
                          "number" == typeof L.pong_timeout &&
                            L.pong_timeout > 0 &&
                            b.set("pongTimeout", 1e3 * L.pong_timeout),
                          "number" == typeof L.login_ts &&
                            b.set("connectedAt", 1e3 * L.login_ts),
                          "number" == typeof L.max_unread_cnt_on_super_group
                            ? b.set(
                                "maxUnreadCountOfSuperGroupChannel",
                                L.max_unread_cnt_on_super_group
                              )
                            : b.set(
                                "maxUnreadCountOfSuperGroupChannel",
                                N.DEFAULT_MAX_UNREAD_COUNT_OF_SUPER_GROUP_CHANNEL
                              ),
                          L.profile_image_encryption &&
                            b.set("profileImageEncryption", !0),
                          A && A.start(),
                          L.hasOwnProperty("file_upload_size_limit") &&
                            L.hasOwnProperty("premium_feature_list") &&
                            L.hasOwnProperty("emoji_hash") &&
                            b.set("appInfo", new he(L)),
                          this.sb.loginHandler(null, this.sb.currentUser)),
                      (this.sb.connecting = !1),
                      (this.sb.reconnecting = !1));
                    break;
                  case "EXPR":
                    L.hasOwnProperty("expires_in") &&
                      "number" == typeof L.expires_in &&
                      L.expires_in > 0 &&
                      k.refresh(function () {});
                    break;
                  case "MESG":
                  ...
                  case "ADMM":
                    ...
                    if (
                      ("MESG" === R.command
                        ...
                        : "FILE" === R.command
                        ? (j = new p(L))
                        : ("BRDM" !== R.command && "ADMM" !== R.command) ||
                          (j = new f(L)),
                      j)
                    ) {
                      var B = this.sb.currentUser
                          ? this.sb.currentUser.userId
                          : null,
                        x = j.silent,
                        q = !!L.force_update_last_message,
                        z = j._sender && j._sender.userId === B;
                      if (j.isGroupChannel()) {
                        var Q = c.cachedChannels.hasOwnProperty(j.channelUrl);
                        c.getChannel(
                          j.channelUrl,
                          N.INTERNAL_CALL,
                          function (e, t) {
                            ...
                            if (!t) {
                              if (
                                !b.container.appInfo.isSupergroupMackDisabled ||
                                !e.isSuper ||
                                e.isBroadcast
                              ) {
                                var a = i.bMessageAck({
                              ...
                              if (
                                ((e.isHidden = !1),
                                (e.hiddenState = c.HiddenState.UNHIDDEN),
                                (c.cachedChannels[e.url] = e),
                                j._sender &&
                                  e.memberMap.hasOwnProperty(j._sender.userId))
                              ) {
                                var s = e.memberMap[j._sender.userId];
                                s.nickname !== j._sender.nickname &&
                                  (s.nickname = j._sender.nickname),
                                  s.plainProfileUrl !==
                                    j._sender.plainProfileUrl &&
                                    (s.plainProfileUrl =
                                      j._sender.plainProfileUrl),
                                  X.deepEqual(s.metaData, j._sender.metaData) ||
                                    (s.metaData = j._sender.metaData),
                                  s.isBlockedByMe !== j._sender.isBlockedByMe &&
                                    (s.isBlockedByMe = j._sender.isBlockedByMe);
                              }
                              var o = n.sb.currentUser;
                              o &&
                                z &&
                                (o.nickname !== j._sender.nickname &&
                                  (o.nickname = j._sender.nickname),
                                o.plainProfileUrl !==
                                  j._sender.plainProfileUrl &&
                                  (o.plainProfileUrl =
                                    j._sender.plainProfileUrl),
                                X.deepEqual(o.metaData, j._sender.metaData) ||
                                  (o.metaData = j._sender.metaData));
                              var l = !1;
                              if (j.mentionType === y.MentionType.CHANNEL)
                                z || (l = !0);
                              else if (j.mentionType === y.MentionType.USERS)
                                for (
                                  var u = 0;
                                  u < j.mentionedUsers.length;
                                  u++
                                )
                                  if (!z && j.mentionedUsers[u].userId === B) {
                                    l = !0;
                                    break;
                                  }
                              (x && !z) ||
                                ((e.isEphemeral || Q) &&
                                  ((!e.lastMessage ||
                                    e.lastMessage.createdAt < j.createdAt) &&
                                    (e.lastMessage = j),
                                  z ||
                                    e._setGroupChannelUnreadCount(
                                      e.unreadMessageCount + 1,
                                      e.unreadMentionCount + (l ? 1 : 0)
                                    ))),
                                q &&
                                  (!e.lastMessage ||
                                    e.lastMessage.createdAt < j.createdAt) &&
                                ...
                                Object.keys(n.sb.channelHandlers).forEach(
                                  function (t) {
                                    ...
                                    i.onMessageReceived(e, j),
                                      l && i.onMentionReceived(e, j);
                                  }
                                );
                            }
                          }
                            ...
                            function (e, t) {
                              ...
                              if (!t) {
                                ...
                                if (j.mentionType === y.MentionType.CHANNEL)
                                  ...
                                  for (
                                    var a = 0;
                                    a < j.mentionedUsers.length;
                                    a++
                                  )
                                    if (j.mentionedUsers[a].userId === B) {
                                      r = !0;
                                      break;
                                    }
                                Object.keys(n.sb.channelHandlers).forEach(
                                  function (t) {
                                    var i = n.sb.channelHandlers[t];
                                    d.enteredChannels[e.url] &&
                                      i.onMessageReceived(e, j),
                                      r && i.onMentionReceived(e, j);
                                  }
                                );
                              }
                            }
                  ...
                  case "AEDI":
                    ...
                    if (
                      ("MEDI" === R.command
                        ...
                        : "FEDI" === R.command
                        ? (Y = new p(L))
                        : "AEDI" === R.command && (Y = new f(L)),
                      Y)
                    ) {
                      var K = this.sb.currentUser
                          ? this.sb.currentUser.userId
                          : null,
                        W = Y.silent,
                        J = Y.sender && Y.sender.userId === K;
                      if (Y.isGroupChannel()) {
                        var Z = c.cachedChannels.hasOwnProperty(Y.channelUrl);
                        c.getChannel(
                          Y.channelUrl,
                          N.INTERNAL_CALL,
                          function (e, t) {
                            ...
                            if (!t) {
                              var r = e.cachedReadReceiptStatus[K],
                                a = r && r >= Y.createAt,
                                s = n.sb.currentUser;
                              s &&
                                J &&
                                (s.nickname !== Y._sender.nickname &&
                                  (s.nickname = Y._sender.nickname),
                                s.plainProfileUrl !==
                                  Y._sender.plainProfileUrl &&
                                  (s.plainProfileUrl =
                                    Y._sender.plainProfileUrl),
                                X.deepEqual(s.metaData, Y._sender.metaData) ||
                                  (s.metaData = Y._sender.metaData));
                              var o = !1,
                                l = !1;
                              if (
                                !J &&
                                !a &&
                                L &&
                                L.hasOwnProperty("old_values")
                              ) {
                                var u =
                                    L.old_values.mention_type || Y.mentionType,
                                  c =
                                    L.old_values.mentioned_user_ids ||
                                    Y.mentionedUsers.map(function (e) {
                                      return e.userId;
                                    });
                                if (
                                  u === y.MentionType.USERS &&
                                  Y.mentionType === y.MentionType.USERS
                                ) {
                                  for (
                                    var d = !1, h = !1, p = 0;
                                    p < c.length;
                                  ...
                                  for (
                                    var f = 0;
                                    f < Y.mentionedUsers.length;
                                    f++
                                  )
                                    if (Y.mentionedUsers[f].userId === K) {
                                      h = !0;
                                      break;
                                    }
                                  !d &&
                                  ...
                                  u === y.MentionType.USERS &&
                                  Y.mentionType === y.MentionType.CHANNEL
                                ) {
                              ...
                              e.lastMessage
                                ? e.lastMessage.createdAt < Y.createdAt
                                  ? ((e.lastMessage = Y), (o = !0))
                                  : e.lastMessage.createdAt === Y.createdAt &&
                                    e.lastMessage.messageId === Y.messageId &&
                                    (Z
                                      ? e.lastMessage.updatedAt < Y.updatedAt &&
                                        ((e.lastMessage = Y), (o = !0))
                                      : (o = !0))
                                : ((e.lastMessage = Y), (o = !0)),
                                (W && !J) ||
                                ...
                                Object.keys(n.sb.channelHandlers).forEach(
                                  function (t) {
                                    var i = n.sb.channelHandlers[t];
                                    i.onMessageUpdated(e, Y),
                                      l && i.onMentionReceived(e, Y);
                                  }
                                );
                            }
                          }
                    ...
                    break;
                  case "DELM":
                    var $ = String(L.channel_type),
                      ee = String(L.channel_url),
                      ne = parseInt(L.msg_id);
                    switch ($) {
                      case o.CHANNEL_TYPE_GROUP:
                        c.getChannel(ee, N.INTERNAL_CALL, function (e, t) {
                          if (n.sb.getErrorFirstCallback()) {
                            var i = [e, t];
                            (t = i[0]), (e = i[1]);
                          }
                      ...
                      case o.CHANNEL_TYPE_OPEN:
                        d.getChannel(ee, N.INTERNAL_CALL, function (e, t) {
                          if (n.sb.getErrorFirstCallback()) {
                            var i = [e, t];
                            (t = i[0]), (e = i[1]);
                          }
                  ...
                  case "READ":
                    var te = new _(L),
                      ie = c.cachedChannels.hasOwnProperty(te.channelUrl);
                    c.getChannel(
                      te.channelUrl,
                      N.INTERNAL_CALL,
                      function (e, t) {
                        ...
                        t ||
                          (ie &&
                            e.updateReadReceipt(te.reader.userId, te.timestamp),
                          n.sb.currentUser &&
                            (te.reader.userId === n.sb.currentUser.userId
                              ? ie
                    ...
                    break;
                  case "MRCT":
                    var re = String(L.channel_type),
                      ae = String(L.channel_url),
                      se = g.createFromJson(L);
                    switch (re) {
                      case o.CHANNEL_TYPE_GROUP:
                        c.getChannel(ae, N.INTERNAL_CALL, function (e, t) {
                          if (n.sb.getErrorFirstCallback()) {
                            var i = [e, t];
                            (t = i[0]), (e = i[1]);
                          }
                        ...
                        break;
                      case o.CHANNEL_TYPE_OPEN:
                        d.getChannel(ae, N.INTERNAL_CALL, function (e, t) {
                          if (n.sb.getErrorFirstCallback()) {
                            var i = [e, t];
                            (t = i[0]), (e = i[1]);
                          }
                    ...
                    break;
                  case "DLVR":
                    var oe = String(L.channel_url),
                      le = L.hasOwnProperty("updated") ? L.updated : null,
                      ue = c.cachedChannels.hasOwnProperty(oe);
                    c.getChannel(oe, N.INTERNAL_CALL, function (e, t) {
                      if (n.sb.getErrorFirstCallback()) {
                        var i = [e, t];
                        (t = i[0]), (e = i[1]);
                      }
                      if (!t) {
                        ...
                        Object.keys(le).forEach(function (t) {
                          n.sb.currentUser &&
                            ...
                            (r = !0),
                            ue && e.updateDeliveryReceipt(t, parseInt(le[t]));
                        }),
                          (c.cachedChannels[e.url] = e),
                          (r && 1 === Object.keys(le).length) ||
                    ...
                    break;
                  case "MTHD":
                    var ce = String(L.channel_url),
                      de = String(L.channel_type),
                      pe = m.createFromJson(L);
                    switch (de) {
                      case o.CHANNEL_TYPE_GROUP:
                        c.getChannel(ce, N.INTERNAL_CALL, function (e, t) {
                          if (n.sb.getErrorFirstCallback()) {
                            var i = [e, t];
                            (t = i[0]), (e = i[1]);
                          }
                        ...
                        break;
                      case o.CHANNEL_TYPE_OPEN:
                        d.getChannel(ce, N.INTERNAL_CALL, function (e, t) {
                          if (n.sb.getErrorFirstCallback()) {
                            var i = [e, t];
                            (t = i[0]), (e = i[1]);
                          }
                  ...
                  case "MCNT":
                    if (
                      L.hasOwnProperty("group_channels") &&
                      Array.isArray(L.group_channels)
                    ) {
                      var fe,
                        ye = [],
                        ge = O(L.group_channels);
                      try {
                        for (ge.s(); !(fe = ge.n()).done; ) {
                          var _e = fe.value;
                          if (_e) {
                            _e.hasOwnProperty("joined_member_count") &&
                              _e.joined_member_count,
                              _e.hasOwnProperty("member_count") &&
                                _e.member_count;
                            var me = c.cachedChannels[_e.channel_url];
                            if (me && me.isBroadcast)
                              me.setLatestMemberCount(
                                _e.member_count,
                                _e.joined_member_count,
                                _e.ts
                              ) && ye.push(me);
                    ...
                    if (
                      L.hasOwnProperty("open_channels") &&
                      Array.isArray(L.open_channels)
                    ) {
                      var ve,
                        Ee = [],
                        Ce = O(L.open_channels);
                      try {
                        for (Ce.s(); !(ve = Ce.n()).done; ) {
                          var be = ve.value;
                          if (be) {
                            be.hasOwnProperty("participant_count") &&
                              be.participant_count;
                            var Ue = d.cachedChannels[be.channel_url];
                            if (Ue)
                              Ue.setLatestParticipantCount(
                                be.participant_count,
                                be.ts
                              ) && Ee.push(Ue);
                          }
                      ...
                      Ee.length > 0 &&
                        Object.keys(this.sb.channelHandlers).forEach(function (
                          ...
                          n.sb.channelHandlers[
                            e
                          ].onChannelParticipantCountChanged(Ee);
                        });
                    }
                    break;
                  case "PEDI":
                    var Se = v.createFromJson(L);
                    Object.keys(this.sb.channelHandlers).forEach(function (e) {
                      n.sb.channelHandlers[e].onPollUpdated(Se);
                    });
                    break;
                  case "VOTE":
                    var ke = E.createFromJson(L);
                    Object.keys(this.sb.channelHandlers).forEach(function (e) {
                      n.sb.channelHandlers[e].onPollVoted(ke);
                    });
                    break;
                  case "SYEV":
                    var Oe = new Ae(L),
                    ...
                    switch (Oe.category) {
                        ...
                        c.getChannel(
                          ...
                          function (e, t) {
                            ...
                            if (t)
                              ...
                              var s = Oe.data.hasOwnProperty("member_count")
                                  ? Oe.data.member_count
                                  : null,
                                o = Oe.data.hasOwnProperty(
                                  "joined_member_count"
                                )
                                  ? Oe.data.joined_member_count
                                  : null,
                                l = !1;
                              if (Oe.category === Ae.CATEGORY_CHANNEL_JOIN) {
                                (Oe.data.hasOwnProperty("users")
                                  ? Oe.data.users
                                  : [Oe.data]
                                ).forEach(function (t) {
                                  e.isSuper || e.isBroadcast
                                    ? (l = e.setLatestMemberCount(s, o, L.ts))
                                    : ((t.state = a.JOINED),
                                      e.addMember(new a(t), Ne),
                                ...
                                var u = new r(Oe.data);
                                n.sb.currentUser &&
                                u.userId === n.sb.currentUser.userId
                                  ? (e.isPublic ||
                                      c.removeCachedChannel(Oe.channelUrl),
                          ...
                          ? c.getChannel(
                              ...
                              function (e, t) {
                                ...
                                if (t)
                                  ...
                                  for (
                                    var a = Oe.data.operators.map(function (e) {
                                        return new r(e);
                                      }),
                                      s = a.map(function (e) {
                                        return e.userId;
                                    ...
                                    e.members[o].role =
                                      s.indexOf(e.members[o].userId) >= 0
                                        ? c.Role.OPERATOR
                                        : c.Role.NONE;
                                  (e.myRole =
                                    n.sb.currentUser &&
                            ...
                            d.getChannel(
                              ...
                              function (e, t) {
                                ...
                                t
                                  ...
                                  : ((e.operators = Oe.data.operators.map(
                                      function (e) {
                                        return new r(e);
                                      }
                                    )),
                        ...
                        c.getChannel(
                          ...
                          function (e, t) {
                            ...
                            if (t)
                              ...
                              Oe.data &&
                                Oe.data.inviter &&
                                Object.keys(Oe.data.inviter).length > 0 &&
                                (s = new r(Oe.data.inviter));
                              for (
                                var o = [], l = 0;
                                l < Oe.data.invitees.length;
                                l++
                              ) {
                                var u = new r(Oe.data.invitees[l]);
                                o.push(u),
                                  (Oe.data.invitees[l].state = a.INVITED);
                                var d = new a(Oe.data.invitees[l]);
                                if (e.isSuper || e.isBroadcast) {
                                  var h = Oe.data.hasOwnProperty("member_count")
                                      ? Oe.data.member_count
                                      : null,
                                    p = Oe.data.hasOwnProperty(
                                      "joined_member_count"
                                    )
                                      ? Oe.data.joined_member_count
                                      : null;
                                  e.setLatestMemberCount(h, p, L.ts);
                                } else e.addMember(d, Ne);
                                n.sb.currentUser &&
                              ...
                              Object.keys(n.sb.channelHandlers).forEach(
                                function (t) {
                                  n.sb.channelHandlers[
                                    t
                                  ].onUserReceivedInvitation(e, s, o);
                                }
                              );
                            }
                          }
                          ...
                          function (e, t) {
                            ...
                            if (t)
                              ...
                              Oe.data &&
                                Oe.data.inviter &&
                                Object.keys(Oe.data.inviter).length > 0 &&
                                (a = new r(Oe.data.inviter));
                              var s = new r(Oe.data.invitee);
                              if (
                                (n.sb.currentUser &&
                                ...
                                var o = Oe.data.hasOwnProperty("member_count")
                                    ? Oe.data.member_count
                                    : null,
                                  l = Oe.data.hasOwnProperty(
                                    "joined_member_count"
                                  )
                                    ? Oe.data.joined_member_count
                                    : null;
                        ...
                        c.getChannel(
                          ...
                          function (e, t) {
                            ...
                            if (t)
                              ...
                              var a = new r(Oe.data);
                              Oe.category === Ae.CATEGORY_TYPING_START
                        ...
                        d.getChannel(
                          ...
                          function (e, t) {
                            ...
                            if (t)
                              ...
                              var a = Oe.data.hasOwnProperty(
                                  "participant_count"
                                )
                                  ? Oe.data.participant_count
                                  : null,
                                s = e.setLatestParticipantCount(a, L.ts),
                                o = new r(Oe.data);
                      ...
                      case Ae.CATEGORY_USER_CHANNEL_UNMUTE:
                        var Te = Oe.category === Ae.CATEGORY_USER_CHANNEL_MUTE,
                          Re = l({}, Oe.data);
                        Te && (Re.restriction_type = s.RestrictionType.MUTED);
                        var Me = Te ? new s(Re) : new r(Oe.data),
                          Pe = Te ? "muted" : "unmuted";
                        Oe.isOpenChannel()
                          ? d.getChannel(
                              Oe.channelUrl,
                          ...
                          : c.getChannel(
                              ...
                              function (e, t) {
                                ...
                                t
                                  ...
                                  : (n.sb.currentUser &&
                                      Me.userId === n.sb.currentUser.userId &&
                                      (e.myMutedState = Pe),
                                    Array.isArray(e.members) &&
                                      e.members
                                        .filter(function (e) {
                                          return e && e.userId === Me.userId;
                                        })
                                        .forEach(function (e) {
                                          (e.isMuted = Te),
                                            (e.restrictionInfo = new C(Re));
                                        }),
                                    Te
                                      ? Object.keys(
                                          n.sb.channelHandlers
                      ...
                      case Ae.CATEGORY_USER_CHANNEL_UNBAN:
                        var Le = Oe.category === Ae.CATEGORY_USER_CHANNEL_BAN,
                          we = l({}, Oe.data);
                        Le && (we.restriction_type = s.RestrictionType.BANNED);
                        var De = Le ? new s(we) : new r(Oe.data);
                        Oe.isOpenChannel()
                          ? d.getChannel(
                              Oe.channelUrl,
                              N.INTERNAL_CALL,
                              function (e, t) {
                                ...
                                if (t)
                                  ...
                                  if (
                                    n.sb.currentUser &&
                                    De.userId === n.sb.currentUser.userId
                                  )
                                    delete d.enteredChannels[Oe.channelUrl],
                              ...
                              function (e, t) {
                                ...
                                if (t)
                                  ...
                                  if (
                                    ...
                                    var r = Oe.data.hasOwnProperty(
                                        "member_count"
                                      )
                                        ? Oe.data.member_count
                                        : null,
                                      a = Oe.data.hasOwnProperty(
                                        "joined_member_count"
                                      )
                                        ? Oe.data.joined_member_count
                                        : null;
                                    e.setLatestMemberCount(r, a, L.ts);
                                  } else
                                    e.removeMember(De),
                                      e.updateJoinedMemberCount();
                                  Object.keys(n.sb.channelHandlers).forEach(
                          ...
                          ? d.getChannel(
                              ...
                              function (e, t) {
                                ...
                                t
                                  ...
                                  : ((e.isFrozen = Oe.data.freeze),
                                    (d.cachedChannels[e.url] = e),
                                    Oe.category === Ae.CATEGORY_CHANNEL_FREEZE
                                      ? Object.keys(
                                          n.sb.channelHandlers
                                        ).forEach(function (t) {
                                          n.sb.channelHandlers[
                          ...
                          : c.getChannelWithoutCache(
                              ...
                              function (e, t) {
                                ...
                                if (t)
                                  ...
                                  e.myCountPreference !==
                                    c.CountPreference.ALL &&
                                    (e.myCountPreference ===
                                    c.CountPreference.UNREAD_MESSAGE_COUNT_ONLY
                                      ? (a = 0)
                                      : e.myCountPreference ===
                                        c.CountPreference
                      ...
                      case Ae.CATEGORY_CHANNEL_META_COUNTERS_CHANGED:
                        var He = Oe.data.hasOwnProperty("created"),
                          Fe = Oe.data.hasOwnProperty("updated"),
                          Ge = Oe.data.hasOwnProperty("deleted");
                        (Oe.isOpenChannel()
                          ? d.getChannel(Oe.channelUrl, N.INTERNAL_CALL)
                          : c.getChannel(Oe.channelUrl, N.INTERNAL_CALL)
                        )
                          .then(function (e) {
                            var t = Oe.data.created,
                              i = Oe.data.updated,
                              r = Oe.data.deleted,
                              a = L.ts;
                            He && e._addOrUpdateCachedMetaData(t, a),
                              Fe && e._addOrUpdateCachedMetaData(i, a),
                              Ge && e._markAsDeletedCachedMetaData(r, a),
                              Object.keys(n.sb.channelHandlers).forEach(
                                function (a) {
                                  var s = n.sb.channelHandlers[a];
                                  Oe.category ===
                                  Ae.CATEGORY_CHANNEL_META_DATA_CHANGED
                                    ? (He && s.onMetaDataCreated(e, t),
                                      Fe && s.onMetaDataUpdated(e, i),
                                      Ge && s.onMetaDataDeleted(e, r))
                                    : (He && s.onMetaCountersCreated(e, t),
                                      Fe && s.onMetaCountersUpdated(e, i),
                                      Ge && s.onMetaCountersDeleted(e, r));
                                }
                              );
                          })
                          .catch(function (e) {
                        ...
                        c.getChannel(
                          ...
                          function (e, t) {
                            ...
                            t
                              ...
                              : Oe.category === Ae.CATEGORY_CHANNEL_HIDE
                              ? ((e.isHidden = !0),
                                Oe.data &&
                                  (Oe.data.hasOwnProperty(
                                    "allow_auto_unhide"
                                  ) &&
                                    (e.hiddenState = Oe.data.allow_auto_unhide
                                      ? c.HiddenState.HIDDEN_ALLOW_AUTO_UNHIDE
                                      : c.HiddenState
                                          .HIDDEN_PREVENT_AUTO_UNHIDE),
                                  Oe.data.hasOwnProperty(
                                    "hide_previous_messages"
                                  ) &&
                                    Oe.data.hide_previous_messages &&
                                    e._setGroupChannelUnreadCount(0, 0)),
                                L.hasOwnProperty("ts_message_offset") &&
                  ...
                  case "USEV":
                    ...
                    switch (je.category) {
                      ...
                      case Ie.CATEGORY_USER_UNBLOCK:
                        var Be = je.data.blocker.user_id,
                          xe = je.data.blockee.user_id;
                        Object.keys(c.cachedChannels).forEach(function (e) {
                          var t = c.cachedChannels[e];
                          try {
                            n.sb.currentUser &&
                              (n.sb.currentUser.userId === Be
                                ? (t.memberMap[xe].isBlockedByMe =
                                    je.category === Ie.CATEGORY_USER_BLOCK)
                                : n.sb.currentUser.userId === xe &&
                                  (t.memberMap[Be].isBlockingMe =
                                    je.category === Ie.CATEGORY_USER_BLOCK));
                          } catch (e) {}
                        });
                        break;
                      case Ie.CATEGORY_FRIEND_DISCOVERED:
                        var qe = je.data.friend_discoveries.map(function (e) {
                          return new r(e);
                        });
                        Object.keys(this.sb.userEventHandlers).forEach(
                          function (e) {
                            n.sb.userEventHandlers[e].onFriendsDiscovered(qe);
                          }
                        );
                    }
                    break;
                  ...
                  case "TPEN":
                    break;
                  default:
                    V.debug("Discard command:", "`".concat(R.command, "`"));
                }
            },
          },
        ]),
  ...
  var Te = (function () {
        ...
        h(
          ...
          [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return ge(
                  this._iid,
                  function (e) {
                    var t = D.get(n._iid).Command,
                      i = gt.getInstance(n._iid),
                      r = t.bRead({ channelUrl: n.url });
                      ...
                      if (r) e(r, null);
                        ...
                        n.updateReadReceipt(
                          ...
                          (n.unreadMessageCount > 0 ||
                            n.unreadMentionCount > 0) &&
                            (n._setGroupChannelUnreadCount(0, 0),
                            Object.keys(i.channelHandlers).forEach(function (
                              e
                            ) {
                              i.channelHandlers[e].onChannelChanged(n);
                            })),
                          e(null, null);
                      else {
                        var s = new SendBirdException(
                          "Connection should be made first.",
                          SendBirdException.CONNECTION_REQUIRED
                        );
                        e(s, null);
                      }
                    });
            ...
            },
            {
              ...
              value: function (e, n) {
                ...
                if (!t || t < n) {
                  ...
                  var i = gt.getInstance(this._iid);
                  i.currentUser &&
            ...
            },
            {
              key: "startTyping",
              value: function () {
                var e = gt.getInstance(this._iid),
                  n = new Date().getTime(),
                      ...
                      s
                        ...
                        : M.get(
                            ...
                            function (e, i) {
                              ...
                              if (!e) {
                                a = new r(i);
                                var s = gt.getInstance(t._iid).currentUser;
                                s &&
                                  a._sender &&
                                  s.userId === a._sender.userId &&
                                  ((s.nickname = a._sender.nickname),
          ...
          [
            ...
            },
            {
              key: "clearCache",
              value: function () {
                (Re[this._iid] = {}), D.get(this._iid).FileMessageQueue.clear();
              },
            },
            {
              key: "getChannel",
            ...
            },
            {
              key: "getChannelCount",
              value: function (e, n) {
                return gt.getInstance(this._iid).getGroupChannelCount(e, n);
              },
            },
            {
              key: "getUnreadItemCount",
              value: function (e, n) {
                return gt.getInstance(this._iid).getUnreadItemCount(e, n);
              },
            },
            {
              key: "getTotalUnreadMessageCount",
            ...
            },
            {
              key: "getTotalUnreadChannelCount",
              value: function (e) {
                return gt.getInstance(this._iid).getTotalUnreadChannelCount(e);
              },
            },
          ]
        ),
          ...
          [
            {
              ...
              value: function (e) {
                ...
                (this.state = e.state),
                  ...
                  this.isMuted &&
                    ((this.restrictionInfo = new i(e)),
                    (this.restrictionInfo.restrictionType =
                      t.RestrictionType.MUTED));
              },
            },
            {
              key: "parse",
          ...
          [
            {
              ...
              value: function (e) {
                var n = D.get(this._iid),
                  ...
                  y = e.restrictionInfo,
                  g = void 0 === y ? null : y,
                  _ = c ? i.objectify(a) : t.objectify(a);
                if (
                  ((_.state = s),
                  (_.role = l),
                  (_.is_muted = c),
                  (_.is_blocked_by_me = h),
                  (_.is_blocking_me = f),
                  g)
                ) {
                  var m = r.objectify(g);
                  (_.restriction_type = m.restriction_type),
                    (_.muted_description = m.description),
                    (_.muted_end_at = m.end_at);
                }
                return _;
              },
            },
    ...
    Ge = (function (e) {
      ...
      function t(e) {
        ...
        return (
          c(this, t),
          ((i = n.call(this, e)).restrictionInfo = null),
          e && i._update(e),
          i
        );
      }
          ...
          [
            {
              key: "_update",
              value: function (e) {
                var n = D.get(this._iid).RestrictionInfo;
                this.restrictionInfo = new n(e);
              },
            },
          ],
          [
            ...
            },
            {
              ...
              value: function (e) {
                var n = D.get(this._iid),
                  ...
                  r = e.restrictionInfo,
                  a = void 0 === r ? {} : r;
                return l(l({}, t.objectify(e)), i.objectify(a));
              },
            },
          ]
        ),
        ...
        h(
          ...
          [
            ...
            },
            {
              key: "clearCache",
              value: function () {
                (qe[this._iid] = {}), D.get(this._iid).FileMessageQueue.clear();
              },
            },
            {
          ...
          [
            {
              ...
              value: function (e) {
                var n = gt.getInstance(this._iid),
                  ...
                  k = void 0 === S ? "" : S,
                  O = e.mentionType,
                  N = void 0 === O ? r.MentionType.USERS : O,
                  T = e.mentionedUsers,
                  R = void 0 === T ? [] : T,
                  M = e.mentionedUserIds,
                  P = void 0 === M ? [] : M,
                  L = e.requestedMentionUserIds,
                  w = void 0 === L ? [] : L,
                  H = e.reactions,
                  F = void 0 === H ? [] : H,
                  G = e.metaArrays,
                  ...
                  se = e.silent,
                  oe = void 0 !== se && se,
                  le = e.isGlobalBlocked,
                  ue = void 0 !== le && le,
                  ce = e.messageSurvivalSeconds,
                  de = void 0 === ce ? -1 : ce,
                  he = e.ogMetaData,
                  pe = void 0 === he ? null : he,
                  fe = e.isOperatorMessage,
                  ye = void 0 !== fe && fe,
                  ge = e.appleCriticalAlertOptions,
                  _e = e.createdAt,
                  me = e.updatedAt,
                  ve = void 0 === me ? 0 : me,
                  Ee = {};
                (Ee.req_id = y),
                  ...
                  (Ee.user = a.objectify({
                    user: _,
                    role:
                      n.currentUser && n.currentUser.userId === _.userId
                        ? m.myRole
                        : _.role,
                    isBlockedByMe: _.isBlockedByMe,
                  })),
                  (Ee.channel_url = m.url),
                  (Ee.channel_type =
                    m.channelType === i.CHANNEL_TYPE_OPEN
                      ? i.CHANNEL_TYPE_OPEN
                      : i.CHANNEL_TYPE_GROUP),
                  (Ee.url = v),
                  (Ee.name = E),
                  ...
                  (Ee.thumbnails = ee),
                  (Ee.require_auth = te),
                  (Ee.is_global_block = !!ue),
                  (Ee.ts = _e),
                  (Ee.updated_at = ve),
                  (Ee.mention_type = N),
                  (Ee.mentioned_users = R.map(function (e) {
                    return s.objectify(e);
                  })),
                  (Ee.mentioned_user_ids = P),
                  (Ee.requested_mention_user_ids = w),
                  (Ee.reactions = F.map(function (e) {
                    return e.serialize();
                  })),
                  (Ee.metaarray = {});
                for (var Ce = 0; Ce < j.length; Ce++) {
                  var be = j[Ce].key;
                  Ee.metaarray[be] = j[Ce].value;
                }
                if (
                  ((Ee.metaarray_key_order = j.map(function (e) {
                    return e.key;
                  })),
                  (Ee.root_message_id = x),
                  (Ee.parent_message_id = z),
                  (Ee.parent_message_text = V),
                  K && (Ee.thread_info = c.objectify(K)),
                  (Ee.is_reply_to_channel = J),
                  Z)
                )
                  switch (Z.messageType) {
                    case i.MESSAGE_TYPE_USER:
                      Ee.parent_message_info = o.objectify(Z);
                      break;
                    case i.MESSAGE_TYPE_FILE:
                      Ee.parent_message_info = l.objectify(Z);
                      break;
                    case i.MESSAGE_TYPE_ADMIN:
                      Ee.parent_message_info = u.objectify(Z);
                  }
                return (
                  (Ee.sending_status =
                    p > 0
                      ? n.MessageSendingStatus.SUCCEEDED
                      : n.MessageSendingStatus.FAILED),
                  ie && (Ee.sending_status = ie),
                  (Ee.silent = !!oe),
                  (Ee.error_code = ae),
                  (Ee.message_survival_seconds = de),
                  pe && (Ee.og_tag = d.objectify(pe)),
                  (Ee.is_op_msg = !!ye),
                  ge && (Ee.apple_critical_alert_options = h.objectify(ge)),
                  Ee
                );
              },
            },
                      ...
                      ? ((n.isLoading = !0),
                        M.get(n._iid).container.apiClient.loadBannedUserList(
                          ...
                          function (t, i) {
                            var r = null;
                            if (!t) {
                              var a = D.get(n._iid).RestrictedUser,
                                s = String(i.next);
                              (n._token = s),
                                (n.hasNext = !!s),
                                (r = i.banned_list.map(function (e) {
                                  var n = new a(e);
                                  return (
                                    (n.restrictionInfo.restrictionType =
                                      a.RestrictionType.BANNED),
                                    n
                                  );
                                }));
                            }
                      ...
                      ? ((n.isLoading = !0),
                        M.get(n._iid).container.apiClient.loadParticipantList(
                          l(
                            l({}, n),
                            {},
                            { channelUrl: dn.get(n), token: n._token }
                          ),
                          function (t, i) {
                            var r = null;
                            if (!t) {
        ...
        h(e, [
          {
            key: "key",
            get: function () {
              return pn.get(this).keyword;
            },
          },
          {
            key: "limit",
            get: function () {
              return pn.get(this).limit;
            },
          },
          {
            key: "reverse",
            get: function () {
              return pn.get(this).reverse;
            },
          },
          {
            key: "exactMatch",
            get: function () {
              return pn.get(this).exactMatch;
            },
          },
          {
            key: "channelUrl",
            get: function () {
              return pn.get(this).channelUrl;
            },
          },
          {
            key: "channelCustomType",
            get: function () {
              return pn.get(this).channelCustomType;
            },
          },
          {
            key: "messageTimestampFrom",
            get: function () {
              return pn.get(this).messageTimestampFrom;
            },
          },
          {
            key: "messageTimestampTo",
            get: function () {
              return pn.get(this).messageTimestampTo;
            },
          },
          {
            key: "order",
            get: function () {
              return pn.get(this).order;
            },
          },
          {
            key: "next",
                      ...
                      M.get(n._iid).container.apiClient.searchMessages(
                        ...
                        function (t, s) {
                          ...
                          t ||
                            ...
                            (pn.get(n).nextToken = s.end_cursor)),
                            (n.isLoading = !1),
                            e(t, o);
                        }
                      ))
    ...
    _n = (function () {
      function e(n) {
        c(this, e),
          ...
          (this.hasMore = !0),
          (this.limit = 20),
          gn.set(this, Number.MAX_SAFE_INTEGER),
          yn.set(this, n),
          (this.reverse = !1),
            ...
            value: function (e, n, t, i) {
              ...
              return (
                ...
                ge(
                  ...
                  function (i) {
                    if (
                      ((("string" != typeof r.customTypeFilter &&
                        null !== r.customTypeFilter) ||
                        ...
                        (null !== r.includeReaction &&
                          "boolean" != typeof r.includeReaction) ||
                        (null !== r.includeReactions &&
                          "boolean" != typeof r.includeReactions) ||
                        "boolean" != typeof r.includeThreadInfo ||
                        (null !== r.includeReplies &&
                          "boolean" != typeof r.includeReplies) ||
                        !(
                          null === r.replyType ||
                          ("string" == typeof r.replyType &&
                            Object.values(o.ReplyType).includes(r.replyType))
                        ) ||
                        (null !== r.includeParentMessageText &&
                      ...
                      if (r.isLoading)
                        ...
                        M.get(r._iid).container.apiClient.getMessageList(
                          {
                            channel: a,
                            token: gn.get(r) || new Date().getTime() + 1e4,
                            tokenType: "timestamp",
                            isInclusive: !1,
                            prevResultSize: e,
                            nextResultSize: 0,
                            ...
                            includeReaction: r.includeReaction,
    ...
    mn = (function () {
      function e() {
        c(this, e),
          ...
          (this.limit = 20),
          (this.includeEmpty = !1),
          (this.order = an.ORDER_LATEST_LAST_MESSAGE),
          (this._token = ""),
          (this.channelNameContainsFilter = ""),
          (this.channelUrlsFilter = []),
          (this.customTypesFilter = []),
          ...
          [
            ...
            },
            {
              ...
              set: function (e) {
                if (Array.isArray(e))
                  for (
                    var n = gt.getInstance(this._iid), t = 0;
                    t < e.length;
                    t++
                  ) {
                    var i = e[t];
            ...
            },
            {
              ...
              set: function (e) {
                kn.set(this, e), (this._parentMessageId = e);
              },
            },
            {
              key: "_validate",
        ...
        h(e, [
          {
            ...
            value: function () {
              ...
              return (
                ...
                (null === this.includeParentMessageText ||
        ...
        h(e, [
          {
            ...
            value: function () {
              ...
              return (
                ...
                Object.values(n.MessageTypeFilter).includes(this.messageType) &&
                ("string" == typeof this.customType ||
                  null === this.customType) &&
                ...
                "boolean" == typeof this.includeMetaArray &&
                (null === this.includeReaction ||
                  "boolean" == typeof this.includeReaction) &&
                (null === this.includeReactions ||
                  "boolean" == typeof this.includeReactions) &&
                "boolean" == typeof this.includeThreadInfo &&
                (null === this.includeReplies ||
                  "boolean" == typeof this.includeReplies) &&
                (null === this.replyType ||
                  ("string" == typeof this.replyType &&
                    Object.values(t.ReplyType).includes(this.replyType))) &&
                (null === this.includeParentMessageText ||
                  "boolean" == typeof this.includeParentMessageText) &&
                (null === this.includeParentMessageInfo ||
                  "boolean" == typeof this.includeParentMessageInfo) &&
          ...
          },
          {
            ...
            value: function (e) {
              var n = D.get(this._iid),
                ...
                a = n.BaseMessage;
              if (this.messageType !== t.MessageTypeFilter.ALL) {
                if (
                  e instanceof i &&
                  this.messageType !== t.MessageTypeFilter.USER
                )
                  return !1;
                if (
                  e instanceof r &&
                  this.messageType !== t.MessageTypeFilter.FILE
                )
                  return !1;
              }
              if (
                ...
                !this.customTypes.includes(e.customType)
              )
                return !1;
              if (
                "string" == typeof this.customType &&
                this.customType !== e.customType
              )
                return !1;
              if (
                Array.isArray(this.senderUserIds) &&
                this.senderUserIds.length > 0
              ) {
                var s = gt.getInstance(e._iid);
                if (
                  !s ||
                  !s.currentUser ||
                  !this.senderUserIds.includes(s.currentUser.userId)
                )
                  return !1;
              }
              if ("string" == typeof this.replyType && e.parentMessageId) {
                if (this.replyType === a.ReplyType.NONE) return !1;
                if (
                  this.replyType === a.ReplyType.ONLY_REPLY_TO_CHANNEL &&
                  !e.isReplyToChannel
                )
                  return !1;
              } else if (!1 === this.includeReplies && e.parentMessageId)
                return !1;
              return !0;
            },
          },
        ...
        h(e, [
          {
            ...
            value: function () {
              return (
                ...
                (null === this.replyType ||
                  ("string" == typeof this.replyType &&
                    Object.values(BaseMessage.ReplyType).includes(
                      this.replyType
                    ))) &&
                (null === this.includeParentMessageText ||
                  "boolean" == typeof this.includeParentMessageText) &&
            ...
            },
            {
              ...
              value: function (e) {
                return (
                  ...
                  ((this.voteCount = e.voteCount), $n.set(this, e.votedAt), !0)
                );
              },
            },
            {
          ...
          [
            {
              key: "_update",
              value: function (e) {
                e.hasOwnProperty("restriction_type") &&
                  (this.restrictionType = e.restriction_type),
                  e.hasOwnProperty("description")
                    ? (this.description = e.description)
                    : e.hasOwnProperty("muted_description") &&
                      (this.description = e.muted_description),
                  e.hasOwnProperty("end_at")
                    ? (this.endAt = parseInt(e.end_at))
                    : e.hasOwnProperty("muted_end_at") &&
                      (this.endAt = parseInt(e.muted_end_at));
              },
            },
          ],
          [
    ...
    it = (function () {
      function e(n) {
        c(this, e), (this.name = tt), (this.volume = 1), n && this._update(n);
      }
      return (
        h(
          e,
    ...
    st = (function () {
      function e(n) {
        c(this, e), (this.isLoading = !1), at.set(this, n);
      }
      return (
        h(e, [
          {
    ...
    ct = (function () {
      function e(n) {
        ...
        n(
          function (e) {
            t.state === ot && ((t.state = lt), (t._value = e));
          },
          function (e) {
            t.state === ot && ((t.state = ut), (t._reason = e));
          }
        );
      }
      return (
    ...
    dt = function () {
      "undefined" == typeof Promise &&
        ("undefined" != typeof window
          ...
          ? (self.Promise = ct)
          : "undefined" != typeof globalThis && (globalThis.Promise = ct)),
        Object.values ||
      ...
      function e() {
        ...
        if (
          ((t.newInstance ||
            !pt ||
            (pt &&
              t.appId !== pt.getApplicationId() &&
              pt.getConnectionState() === pt.ConnectionState.CLOSED)) &&
            ((i = !0), (pt = this)),
          i)
        ) {
          try {
            if (!t.hasOwnProperty("appId"))
              return V.warn("Must be set appId."), (pt = null), null;
          } catch (e) {
            return V.warn("Must be set appId."), (pt = null), null;
          }
          var r = Te.create();
          ...
          var a = {
              ...
              FileMessage: Ke,
              AdminMessage: We,
              GroupChannelListQuery: an,
              MemberListQuery: sn,
              GroupChannelParams: In,
              OpenChannelParams: Sn,
              BaseMessageParams: On,
              UserMessageParams: Nn,
              FileMessageParams: Tn,
              ScheduledUserMessageParams: Rn,
              GroupChannelTotalUnreadMessageCountParams: Mn,
              MessageRetrievalParams: Pn,
              MessageListParams: Ln,
              ThreadedMessageListParams: wn,
              MessageChangeLogsParams: Dn,
              GroupChannelChangeLogsParams: Hn,
              PollParams: Fn,
              PollRetrievalParams: Gn,
              MessageMetaArray: zn,
              UserEventHandler: Bn,
              SessionHandler: ae,
              ChannelHandler: xn,
              ConnectionHandler: jn,
              AppleCriticalAlertOptions: it,
              Poll: Xn,
              PollOption: et,
            },
            s = {
              ...
              BaseMessage: ve,
              UserListQuery: rt,
              ApplicationUserListQuery: en,
              BannedUserListQuery: nn,
              BlockedUserListQuery: tn,
              FriendListQuery: rn,
              MutedUserListQuery: on,
              OpenChannelListQuery: ln,
              OperatorListQuery: cn,
              ParticipantListQuery: hn,
              MessageListQuery: st,
              PreviousMessageListQuery: _n,
              MessageSearchQuery: fn,
              PublicGroupChannelListQuery: mn,
              PollListQuery: Cn,
              PollVoterListQuery: An,
        ...
        h(
          ...
          [
            ...
            },
            {
              key: "setDebugMode",
              value: function (e) {
                (yt = e), (V.mode = e ? V.Mode.DEBUG : V.Mode.PRODUCTION);
              },
            },
            {
