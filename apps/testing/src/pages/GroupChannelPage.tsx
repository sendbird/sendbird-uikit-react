...
export function GroupChannelPage() {
  ...
  return <GroupChannelApp {...props} uikitOptions={{ groupChannel: { enableFormTypeMessage: true }}} breakpoint={/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)} config={{ logLevel: 'all' }} />;
}
