...
// Channel/utils/compareMessagesForGrouping               <-  src/utils/messages.ts
// Channel/utils/getMessagePartsInfo                      <-  src/modules/GroupChannel/components/MessageList/getMessagePartsInfo.ts
